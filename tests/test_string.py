...
class TestSplitcaps(object):
    ...
    @pytest.mark.parametrize('s,expected,kwargs', [
        ('asdf test', ['asdf test'], {'pattern': r''}),
        ('asdf test', ['asdf', 'test'], {'pattern': r'\s+'}),
        ('asdf test ', ['asdf', 'test'], {'pattern': r'\s+'}),
        ('asdf test', ['asdf test'], {'pattern': r''}),
        ('asdf test', ['asdf', ' ', 'test'], {'pattern': r'(\s+)'}),
        ('asdf test ', ['asdf', ' ', 'test', ' '], {'pattern': r'(\s+)'}),
        ('ASDf Test', ['AS', 'Df ', 'Test'], {'pattern': r''}),
        ('ASDf Test', ['AS', 'Df', 'Test'], {'pattern': r'\s+'}),
        ('ASDf Test', ['AS', 'Df', ' ', 'Test'], {'pattern': r'(\s+)'}),
        ('ASDf Test', ['AS', 'Df ', 'T', 't'],
         {'pattern': r'es'}),
    ...
    @pytest.mark.parametrize('s,expected,kwargs', [
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa1Bb2Cc3Dd4Ee5Ff6'],
         {'maxsplit': 0, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': None, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': -1, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': -2, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': 12, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': 11, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff'],
         {'maxsplit': 10, 'pattern': r'\d+'}),
        ('Aa1Bb2Cc3Dd4Ee5Ff6', ['Aa', 'Bb', 'Cc', 'Dd', 'Ee', 'Ff6'],
         {'maxsplit': 5, 'pattern': r'\d+'}),
        ('aa1Bb2Cc3Dd4Ee5Ff6', ['aa', 'Bb', 'Cc', 'Dd', 'Ee5Ff6'],
         {'maxsplit': 4, 'pattern': r'\d+'}),
        ('Aa1Bb2Cc3Dd4Ee5Ff6', ['Aa', 'Bb', 'Cc', 'Dd4Ee5Ff6'],
         {'maxsplit': 3, 'pattern': r'\d+'}),
    ...
    @pytest.mark.parametrize('s,expected,kwargs', [
        ...
        ('ASDf test', ['f test'], {'pattern': r'[A-Z]', 'flags': 0}),
        ('ASDf test', ['A', 'S', 'D', 'f test'],
         {'pattern': r'([A-Z])', 'flags': 0}),
        ('ASDf test', [' '],
         {'pattern': r'[A-Z]', 'flags': re.IGNORECASE}),
